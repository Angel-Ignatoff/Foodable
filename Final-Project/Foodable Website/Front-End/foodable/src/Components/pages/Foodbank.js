...
export default function App() {
  const { isLoaded, loadError } = useLoadScript({
    //googleMapsApiKey: "AIzaSyDWY-Raf2RbTot-5OyNG_ZDm_T0aaaq8QA",// key updated due to the fact that it expired on 1/4/2022, I have let Ms.Cigdem know
    googleMapsApiKey: "AIzaSyAaBuwmR3NuP87zdAWICjBArShWTMKoc9c",
